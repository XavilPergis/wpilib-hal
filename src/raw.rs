...
impl HAL_ControlWord {
    ...
    pub fn enabled(&self) -> u32 {
        unsafe { ::std::mem::transmute(((self._bitfield_1 & (1usize as u32)) >> 0u32) as u32) }
    }
    #[inline]
    ...
    pub fn autonomous(&self) -> u32 {
        unsafe { ::std::mem::transmute(((self._bitfield_1 & (2usize as u32)) >> 1u32) as u32) }
    }
    #[inline]
    ...
    pub fn test(&self) -> u32 {
        unsafe { ::std::mem::transmute(((self._bitfield_1 & (4usize as u32)) >> 2u32) as u32) }
    }
    #[inline]
    ...
    pub fn eStop(&self) -> u32 {
        unsafe { ::std::mem::transmute(((self._bitfield_1 & (8usize as u32)) >> 3u32) as u32) }
    }
    #[inline]
    ...
    pub fn fmsAttached(&self) -> u32 {
        unsafe { ::std::mem::transmute(((self._bitfield_1 & (16usize as u32)) >> 4u32) as u32) }
    }
    #[inline]
    ...
    pub fn dsAttached(&self) -> u32 {
        unsafe { ::std::mem::transmute(((self._bitfield_1 & (32usize as u32)) >> 5u32) as u32) }
    }
    #[inline]
    ...
    pub fn control_reserved(&self) -> u32 {
        unsafe {
            ::std::mem::transmute(((self._bitfield_1 & (4294967232usize as u32)) >> 6u32) as u32)
        }
    }
    #[inline]
    pub fn set_control_reserved(&mut self, val: u32) {
        self._bitfield_1 &= !(4294967232usize as u32);
        self._bitfield_1 |= ((val as u32 as u32) << 6u32) & (4294967232usize as u32);
    }
}
#[repr(u32)]
#[derive(Debug, Copy, Clone, PartialEq, Eq, Hash)]
...
pub type HAL_NotifierProcessFunction =
    ::std::option::Option<unsafe extern "C" fn(currentTime: u64, handle: HAL_NotifierHandle)>;
...
extern "C" {
    ...
    pub fn HAL_GetAnalogAverageBits(analogPortHandle: HAL_AnalogInputHandle,
                                    status: *mut i32)
                                    -> i32;
    pub fn HAL_SetAnalogOversampleBits(analogPortHandle: HAL_AnalogInputHandle,
                                       bits: i32,
                                       status: *mut i32);
    pub fn HAL_GetAnalogOversampleBits(analogPortHandle: HAL_AnalogInputHandle,
                                       status: *mut i32)
                                       -> i32;
    ...
    pub fn HAL_GetAnalogAverageVoltage(analogPortHandle: HAL_AnalogInputHandle,
                                       status: *mut i32)
                                       -> f64;
    ...
    pub fn HAL_SetAnalogTriggerLimitsRaw(analogTriggerHandle: HAL_AnalogTriggerHandle,
                                         lower: i32,
                                         upper: i32,
                                         status: *mut i32);
    pub fn HAL_SetAnalogTriggerLimitsVoltage(analogTriggerHandle: HAL_AnalogTriggerHandle,
                                             lower: f64,
                                             upper: f64,
                                             status: *mut i32);
    pub fn HAL_SetAnalogTriggerAveraged(analogTriggerHandle: HAL_AnalogTriggerHandle,
                                        useAveragedValue: HAL_Bool,
                                        status: *mut i32);
    pub fn HAL_SetAnalogTriggerFiltered(analogTriggerHandle: HAL_AnalogTriggerHandle,
                                        useFilteredValue: HAL_Bool,
                                        status: *mut i32);
    pub fn HAL_GetAnalogTriggerInWindow(analogTriggerHandle: HAL_AnalogTriggerHandle,
                                        status: *mut i32)
                                        -> HAL_Bool;
    pub fn HAL_GetAnalogTriggerTriggerState(analogTriggerHandle: HAL_AnalogTriggerHandle,
                                            status: *mut i32)
                                            -> HAL_Bool;
    pub fn HAL_GetAnalogTriggerOutput(analogTriggerHandle: HAL_AnalogTriggerHandle,
    ...
    pub fn HAL_SetCompressorClosedLoopControl(compressorHandle: HAL_CompressorHandle,
                                              value: HAL_Bool,
                                              status: *mut i32);
    pub fn HAL_GetCompressorClosedLoopControl(compressorHandle: HAL_CompressorHandle,
                                              status: *mut i32)
                                              -> HAL_Bool;
    pub fn HAL_GetCompressorPressureSwitch(compressorHandle: HAL_CompressorHandle,
                                           status: *mut i32)
                                           -> HAL_Bool;
    pub fn HAL_GetCompressorCurrent(compressorHandle: HAL_CompressorHandle,
                                    status: *mut i32)
                                    -> f64;
    pub fn HAL_GetCompressorCurrentTooHighFault(compressorHandle: HAL_CompressorHandle,
                                                status: *mut i32)
                                                -> HAL_Bool;
    pub fn HAL_GetCompressorCurrentTooHighStickyFault(compressorHandle: HAL_CompressorHandle,
                                                      status: *mut i32)
                                                      -> HAL_Bool;
    pub fn HAL_GetCompressorShortedStickyFault(compressorHandle: HAL_CompressorHandle,
                                               status: *mut i32)
                                               -> HAL_Bool;
    pub fn HAL_GetCompressorShortedFault(compressorHandle: HAL_CompressorHandle,
                                         status: *mut i32)
                                         -> HAL_Bool;
    pub fn HAL_GetCompressorNotConnectedStickyFault(compressorHandle: HAL_CompressorHandle,
                                                    status: *mut i32)
                                                    -> HAL_Bool;
    pub fn HAL_GetCompressorNotConnectedFault(compressorHandle: HAL_CompressorHandle,
                                              status: *mut i32)
                                              -> HAL_Bool;
    pub fn HAL_GetSystemClockTicksPerMicrosecond() -> i32;
    pub fn HAL_InitializeCounter(mode: HAL_Counter_Mode,
                                 index: *mut i32,
                                 status: *mut i32)
                                 -> HAL_CounterHandle;
    ...
    pub fn HAL_SetCounterExternalDirectionMode(counterHandle: HAL_CounterHandle,
                                               status: *mut i32);
    ...
    pub fn HAL_SetCounterReverseDirection(counterHandle: HAL_CounterHandle,
                                          ...
                                          status: *mut i32);
    pub fn HAL_InitializeDIOPort(portHandle: HAL_PortHandle,
                                 input: HAL_Bool,
                                 status: *mut i32)
                                 -> HAL_DigitalHandle;
    ...
    pub fn HAL_SetErrorData(errors: *const ::std::os::raw::c_char,
                            ...
                            waitMs: i32)
                            -> i32;
    pub fn HAL_SendError(isError: HAL_Bool,
                         errorCode: i32,
                         isLVCode: HAL_Bool,
    ...
    pub fn HAL_SetJoystickOutputs(joystickNum: i32,
                                  outputs: i64,
                                  leftRumble: i32,
                                  rightRumble: i32)
                                  -> i32;
    ...
    pub fn HAL_TransactionI2C(port: i32,
                              deviceAddress: i32,
                              dataToSend: *mut u8,
                              sendSize: i32,
                              dataReceived: *mut u8,
                              receiveSize: i32)
                              -> i32;
    pub fn HAL_WriteI2C(port: i32, deviceAddress: i32, dataToSend: *mut u8, sendSize: i32) -> i32;
    pub fn HAL_ReadI2C(port: i32, deviceAddress: i32, buffer: *mut u8, count: i32) -> i32;
    pub fn HAL_CloseI2C(port: i32);
    pub fn HAL_InitializeInterrupts(watcher: HAL_Bool, status: *mut i32) -> HAL_InterruptHandle;
    pub fn HAL_CleanInterrupts(interruptHandle: HAL_InterruptHandle, status: *mut i32);
    ...
    pub fn HAL_ReadInterruptRisingTimestamp(interruptHandle: HAL_InterruptHandle,
                                            status: *mut i32)
                                            -> f64;
    pub fn HAL_ReadInterruptFallingTimestamp(interruptHandle: HAL_InterruptHandle,
                                             status: *mut i32)
                                             -> f64;
    ...
    pub fn HAL_AttachInterruptHandler(interruptHandle: HAL_InterruptHandle,
                                      ...
                                      param: *mut ::std::os::raw::c_void,
                                      status: *mut i32);
    pub fn HAL_AttachInterruptHandlerThreaded(interruptHandle: HAL_InterruptHandle,
                                              handler: HAL_InterruptHandlerFunction,
                                              param: *mut ::std::os::raw::c_void,
                                              status: *mut i32);
    ...
    pub fn HAL_InitializeNotifier(process: HAL_NotifierProcessFunction,
                                  ...
                                  status: *mut i32)
                                  -> HAL_NotifierHandle;
    pub fn HAL_InitializeNotifierThreaded(process: HAL_NotifierProcessFunction,
                                          param: *mut ::std::os::raw::c_void,
                                          status: *mut i32)
                                          -> HAL_NotifierHandle;
    ...
    pub fn HAL_UpdateNotifierAlarm(notifierHandle: HAL_NotifierHandle,
                                   triggerTime: u64,
                                   status: *mut i32);
    pub fn HAL_StopNotifierAlarm(notifierHandle: HAL_NotifierHandle, status: *mut i32);
    ...
    pub fn HAL_GetPDPChannelCurrent(module: i32, channel: i32, status: *mut i32) -> f64;
    ...
    pub fn HAL_InitializeRelayPort(portHandle: HAL_PortHandle,
                                   fwd: HAL_Bool,
                                   status: *mut i32)
                                   -> HAL_RelayHandle;
    ...
    pub fn HAL_TransactionSPI(port: i32,
                              dataToSend: *mut u8,
                              dataReceived: *mut u8,
                              size: i32)
                              -> i32;
    ...
    pub fn HAL_SetSPIOpts(port: i32,
                          msbFirst: HAL_Bool,
    ...
    pub fn HAL_InitSPIAccumulator(port: i32,
                                  period: i32,
                                  cmd: i32,
                                  xferSize: i32,
                                  validMask: i32,
    ...
    pub fn HAL_SetSPIAccumulatorCenter(port: i32, center: i32, status: *mut i32);
    pub fn HAL_SetSPIAccumulatorDeadband(port: i32, deadband: i32, status: *mut i32);
    ...
    pub fn HAL_GetSPIAccumulatorOutput(port: i32,
                                       value: *mut i64,
                                       count: *mut i64,
                                       status: *mut i32);
    pub fn HAL_InitializeSerialPort(port: HAL_SerialPort, status: *mut i32);
    pub fn HAL_SetSerialBaudRate(port: HAL_SerialPort, baud: i32, status: *mut i32);
    pub fn HAL_SetSerialDataBits(port: HAL_SerialPort, bits: i32, status: *mut i32);
    pub fn HAL_SetSerialParity(port: HAL_SerialPort, parity: i32, status: *mut i32);
    pub fn HAL_SetSerialStopBits(port: HAL_SerialPort, stopBits: i32, status: *mut i32);
    pub fn HAL_SetSerialWriteMode(port: HAL_SerialPort, mode: i32, status: *mut i32);
    pub fn HAL_SetSerialFlowControl(port: HAL_SerialPort, flow: i32, status: *mut i32);
    pub fn HAL_SetSerialTimeout(port: HAL_SerialPort, timeout: f64, status: *mut i32);
    pub fn HAL_EnableSerialTermination(port: HAL_SerialPort,
                                       terminator: ::std::os::raw::c_char,
                                       status: *mut i32);
    pub fn HAL_DisableSerialTermination(port: HAL_SerialPort, status: *mut i32);
    pub fn HAL_SetSerialReadBufferSize(port: HAL_SerialPort, size: i32, status: *mut i32);
    pub fn HAL_SetSerialWriteBufferSize(port: HAL_SerialPort, size: i32, status: *mut i32);
    pub fn HAL_GetSerialBytesReceived(port: HAL_SerialPort, status: *mut i32) -> i32;
    ...
    pub fn HAL_Report(resource: i32,
                      instanceNumber: i32,
                      context: i32,
